...
?>
                            <form action="Profile-confirm_modif.php" method="post">
                                <p>
                                    ...
                                    <input type="text" name="username" class="form-control"  id="exampleFormControlInput1 firstname" value="<?= $liste['username'] ?>">
                                </p>
                                <p>
                                ...
                                <p><input type="submit" class="site-btn" value="Enregistrer"></p>
                            </form> 

                            <a href="paiement.php"> <input type="submit"  class="site-btn" value="Ajouter une Carte"></a><br><br><br>
                            <a href="modif_paiement.php"> <input type="submit"  class="site-btn" value="Modification de Carte"></a>
